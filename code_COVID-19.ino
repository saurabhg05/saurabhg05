...
#endif
   const char* ssid = "wifi_name";  //Enter your SSID of your WiFi (keep it within double quote)
    const char* password = "password";  //Enter your PASSWORD of your WiFi (keep it within double quote)
    WiFiClient client; 
...
//  display.setFont(&FreeMono9pt7b);
  ...
  display.println("In India");//can change the name 
  display.display();
  delay(200);
  display.clearDisplay();
    Serial.begin(115200);
